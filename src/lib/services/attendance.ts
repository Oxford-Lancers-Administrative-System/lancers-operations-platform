...
async function mintWalkUpProspect(
  ...
  // whoever picks this up next will recognise — "walk-up", not "walk-on":
  // Brian locked the word 2026-08-31, and this is the one place that composes
  // it into text an operator reads on the recruit board's own Source column
  // (LAN-204, correction 2026-09-02).
  await tx.query(
