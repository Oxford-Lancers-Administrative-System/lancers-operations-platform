...
/** S4 — Create event, on the kit (LAN-225). Same gate/services as `/operate/events/new`; the two info alerts become the subtitle and a helper line (E2). Nothing posts. */
