...
| `/design-preview/player-home`      | `/events/[token]`                          | S9                                 |
| `/design-preview/player-details`   | `/onboarding/[token]` (step 1)             | S10                                |
| `/design-preview/player-agreement` | `/onboarding/[token]?step=code_of_conduct` | S10b                               |
| `/design-preview/answer`           | `/a/<yes                                   | no>/[token]` (a Yes already taken) | S11 |
