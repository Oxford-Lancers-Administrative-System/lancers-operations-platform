...
/**
 * The way back to this page from the two pages that used to be dead ends —
 * LAN-343. Declared here, where the page itself is, and imported by
 * `/rsvp/[token]` and `/a/<yes|no>/[token]` rather than written out twice: one
