...
describe("the Roles page", () => {
  ...
  it("shortens a long summary rather than filling the row with a paragraph", async () => {
    ...
    // The General Manager holds eleven — ten until LAN-399 added
    // `operator_guide`, nine until LAN-361 added `person_erasure`, eight until
    // LAN-215 added `roster_bulk_import`, seven until LAN-183 added
