...
| `kit_issue_records`                   | LAN-375. Which kit a player was issued this season — one row per filled item, `unique (season_membership_id, item)`, value proved against that item's own list by composite foreign key. Braces 1 and Braces 2 are two items of this table's own shape, each blank or one value; there is no count field anywhere (Brian, 2026-09-16). Not an inventory. A trigger on this table maintains the derived Kit Distributed onboarding item — see the invariant note below.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
