...
no longer being asked — and the key carries `on update cascade` behind that, so
a future writer who forgets cannot turn LAN-391's legal edit into a database
refusal.
