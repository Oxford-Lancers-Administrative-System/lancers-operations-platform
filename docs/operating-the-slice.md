...
| 7   | **Consolidated cleanup**   | Run every scenario cleanup in the order in [`../scripts/pilot/lan-82/README.md`](../scripts/pilot/lan-82/README.md), then `verify-clean.sql`, and confirm it reports every scenario gone and the durable pilot foundation intact.  |
