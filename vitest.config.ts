...
export const DATABASE_TEST_SUITES: readonly string[] = [
  ...
  "src/app/operate/admin/roles/[roleId]/access-actions.test.ts",
  ...
  "src/lib/services/event-audience-amendment.test.ts",
  "src/lib/services/event-audience-rule.test.ts",
  ...
  "src/lib/services/onboarding-activity-log.test.ts",
  "src/lib/services/onboarding-agreements.test.ts",
  "src/lib/services/onboarding-ask.test.ts",
  "src/lib/services/onboarding-chase-dispatch.test.ts",
  "src/lib/services/onboarding-chase-player-outstanding.test.ts",
  "src/lib/services/onboarding-chase.test.ts",
  ...
  "src/lib/services/roster-import.test.ts",
  ...
  "tests/event-audience-payload.test.tsx",
  ...
  "tests/prospect-record-payload.test.tsx",
