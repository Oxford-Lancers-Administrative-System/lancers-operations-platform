...
export const WORKFLOWS = Object.freeze([
  ...
  wf(
    ...
    "President, General Manager or IT Officer",
    "tester2",
    ["/operate/admin/roles/{role.kit_manager}", "/operate/admin/operators/{operator.other-seat}"],
    ["seat.held"],
  ...
  wf(
    ...
    "tester3",
    ["/operate/admin/operators/{operator.other-seat}", "/operate/admin/roles/{role.kit_manager}"],
    ["audit.row"],
