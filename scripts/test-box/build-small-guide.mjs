...
const cases = [
  [
    ...
    "12 WhatsApp invitations can be delivered in simulation. Norbert and Osgood have no phone and use email fallback. The six quick Yes/No players plus Rowan (coach) answer after one simulated minute. Peregrine is the escalation recipient and is not in the event audience.",
  ],
  [
    "02",
  ...
  [
    ...
    "Before the repair, WhatsApp cannot send and email is captured as fallback. After the repair, confirm the new destination in the panel and check a fresh delivery. New valid contacts work without a recipient allowlist refresh; actual WhatsApp delivery still requires explicit per-person selection in the panel.",
  ],
];
const html = `<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Lancers · Small squad WhatsApp walkthrough</title>
