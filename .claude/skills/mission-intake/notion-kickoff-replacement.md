...
The row commissions a subject, not a closed feature list. Grounded in current
`main`, intake maps its workflows, administration, gaps, and mission seams before
the workflow inventory freezes.
