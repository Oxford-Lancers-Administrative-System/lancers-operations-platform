...
| ------- | ------------------ | ----------------------------------------------------- |
| `W4-01` | `/a/y.f7ee136f-…`  | Merrick Thornbury — the imported returner            |
| `W4-02` | `/a/y.3ec61c6f-…`  | Rosalind Penhaligon — the flipped recruit            |
| `W4-03` | `/a/y.f7ee136f-…`  | Merrick, after submitting                            |
| `W4-04` | `/a/y.3ec61c6f-…`  | Rosalind, with nothing left to give                  |
| `W4-05` | `/a/y.153f0efc-…`  | no subject — a token that resolves to nothing        |
