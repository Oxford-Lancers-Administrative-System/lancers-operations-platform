...
| `W4-03` | `/a/y.f7ee136f-…`  | the Code of Conduct page                             |
| `W4-04` | `/a/y.f7ee136f-…`  | the photo release page                               |
| `W4-05` | `/a/y.f7ee136f-…`  | BUCS Play and Hudl                                   |
| `W4-06` | `/a/y.f7ee136f-…`  | Merrick, having finished the sequence                |
| `W4-07` | `/a/y.3ec61c6f-…`  | Rosalind, with nothing left to give                  |
| `W4-08` | `/a/y.153f0efc-…`  | no subject — a token that resolves to nothing        |

`W4-03` through `W4-06` are states of the sequence that no seeded row produces —
