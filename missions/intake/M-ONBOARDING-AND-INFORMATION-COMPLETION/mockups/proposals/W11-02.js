(async () => {
  ...
  setAdminIntro({
    ...
    note: "Recruitment's cadence is not a property of a practice, and onboarding's is not either. Four more columns here would be null five times over.",
  });
  ...
  const events = [
    ...
    [
      ...
      "recruit_invitation_lead_days · null",
      "recruit_follow_up_cadence_hours · null",
    ],
