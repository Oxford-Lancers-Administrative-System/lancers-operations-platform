...
design sprint on 2026-09-25 from the definition recorded on LAN-424; round 3
applies Brian's call with Stewart (2026-09-25) and his amendments after it.
...
2. `W2` — Edit roster group colours: the club (proposed: `role_management`) → each of the board's ten groups wears a colour chosen from the app's palette, set from an _Edit categories_ control on the roster
...
- Copy access from another seat and Grant everything are seat-page actions, each one
  audited action: proposed for owner approval. No time-limited delegation.
...
- Excluded: per-group scoping for coaches; who may pause messaging (LAN-407);
  ...
  any change to the event templates page.
