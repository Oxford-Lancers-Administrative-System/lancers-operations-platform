/* W1-04 — generated from the shared prelude, kit and this screen's body; see the notes inside. */
(async () => {
  /*
  ...
  /*
   * W1-04 — the Vice-President's seat page: starts with everything and loses
   * any one grant with one tap. At 375 the four groups fold (the Section
   * disclosure) with each group's count as its summary.
   */
  await appButtons();
  accessSection({ grants: seed("full"), fold: PHONE, actions: true });
})();
