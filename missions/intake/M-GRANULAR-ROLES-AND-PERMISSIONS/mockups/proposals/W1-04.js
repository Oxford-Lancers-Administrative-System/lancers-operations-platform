/* W1-04 — generated from the shared prelude, kit, seatkit and this screen's body; see the notes inside. */
(async () => {
  /*
  ...
  /*
   * W1-04 — one seat at a time: the Vice-President, who starts with
   * everything and can lose any one grant. Round 2: four switches, no
   * Permissions block, and at 375 the three groups fold (the Section
   * disclosure) with each group's count as its summary, so the page opens short.
   */
  accessSection({ grants: seed("full"), fold: PHONE });
})();
