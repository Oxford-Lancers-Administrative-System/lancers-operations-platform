/* W1-05 — generated from the shared prelude, kit, seatkit and this screen's body; see the notes inside. */
(async () => {
  /*
   ...
   * `Central rule` chip naming LAN-423, with the sentence that says why
   * (docs/ux/standards.md rule 4). Round 2: four switches, no Permissions
   * block, the three groups folded at 375.
   */
