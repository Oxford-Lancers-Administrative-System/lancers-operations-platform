/* W1-05 — generated from the shared prelude and this screen's body; see the notes inside. */
(async () => {
  /*
  ...
  /*
   * W1-05 — a fixed seat. The President's grants are shown as locked controls
   * under a `Central rule` chip naming LAN-423; nothing on the page can reduce
   * them, and the sentence beside the chip says why (docs/ux/standards.md rule 4).
   */
  (() => {
    const { permissions } = accessSection({ grants: seed("floor"), locked: true });
    keepOtherPermissions(permissions, [
      "Can manage operator accounts",
