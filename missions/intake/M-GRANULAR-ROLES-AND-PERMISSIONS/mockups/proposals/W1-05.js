/* W1-05 — generated from the shared prelude, kit and this screen's body; see the notes inside. */
(async () => {
  /*
  ...
  /*
   * W1-05 — a fixed seat. The President's grants are locked controls under a
   * `Central rule` chip naming LAN-423, with the sentence that says why. No
   * mass edits: nothing can be copied into or granted to a seat that already
   * holds everything and cannot be reduced. Folded at 375.
   */
  accessSection({ grants: seed("floor"), locked: true, fold: PHONE });
})();
