/* W1-02b — generated from the shared prelude, kit, altb and this screen's body; see the notes inside. */
(async () => {
  /*
  ...
  /* W1-02b — Alternative B, the collapsed matrix, the Kit Manager's row open (W1-03's example change applied). */
  await drawCollapsedMatrix({ open: "Kit Manager", grantsFor: { "Kit Manager": seed("kit") } });
})();
