...
(async () => {
  ...
  /*
   * W4-05 — one game as a seat with View on the Game template (the Gameday
   * Secretary in this example), None on every other template. View shows everything in the event: audience, answers,
