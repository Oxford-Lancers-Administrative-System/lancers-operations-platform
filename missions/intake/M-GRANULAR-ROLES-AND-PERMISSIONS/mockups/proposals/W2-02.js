/* W2-02 — generated from the shared prelude and this screen's body; see the notes inside. */
(async () => {
  /*
  ...
  /* W2-02 — the Social template, which already has events: its category is shown and fixed. */
  await categoryField({ category: "Social", locked: true, open: false });
})();
