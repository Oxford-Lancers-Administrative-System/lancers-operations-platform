...
`2072ecd`; the entire workflow is new. `events.season_id` is already non-null
...
| Where the import and export actions sit in the Events area                                                         | `delegated to Mission Lead`   | Must be reachable from the season that is being read                                                                             | Delegated       |
