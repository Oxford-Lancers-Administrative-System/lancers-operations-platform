...
- **The public tier shows the whole event record and no participation data.**
  Brian, 2026-08-20: "people who see the calendar should see a normal calendar
  ...
  nature, that shouldn't be on the public calendar." A public event page must
  therefore be able to render an event without touching participation data at
  all, not merely hide it after loading.
- **Where participation data becomes visible is `W7`'s question, not this
  one.** `W1` needs only that the public page can render an event without
  touching participation data at all; which non-public tier may see it is
  settled against `W7`'s mockup.
...
| The public tier shows the whole event record and no participation data — name, type, date, time, venue or online destination, description, required equipment, mandatory or optional, for all seven types, and never a person | `locked`                    | Brian, 2026-08-20, quoted in the privacy section above; confirms the recommended default and D2's public row                                                                                                                                                                                                                                                                                                                                                       | Settled         |
| The public calendar is a top-level, easily shared route; `/calendar` recommended, with `/operate/events/calendar` retained for operators and both rendering from the same components                                          | `locked`                    | Brian, 2026-08-20: "there should be a top-level calendar that's easy to share with people." The final hostname is LAN-126's, not this mission's                                                                                                                                                                                                                                                                                                                    | Settled         |
| Does the club-link tier survive as approved?                                                                                                                                                                                  | **deferred to `W7`**        | D2 and D3 give the club link audience, RSVP and attendance, leaving delivery as the only operator-locked element. Brian's 2026-08-20 wording — "if you're not an operator, you don't get to see the attendance" — may collapse that middle tier. It is a question about who sees participation data, which is `W7`'s subject, and Brian settles it against `W7`'s mockup rather than in the abstract. It does not bear on `W1`, whose public tier is settled above | Deferred — `W7` |
