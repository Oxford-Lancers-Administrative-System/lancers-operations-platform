...
- **Where participation data becomes visible is the one open question**, and it
  sits in the decision table below rather than being resolved here.
...
| **Does the club-link tier survive as approved?**                                                                                                                                                                              | `proposed for owner approval` | D2 and D3 give the club link audience, RSVP and attendance, leaving delivery as the only operator-locked element. Brian's 2026-08-20 wording — "if you're not an operator, you don't get to see the attendance" — reads as moving attendance and RSVP behind an operator account and collapsing the middle tier. Recommended default: **keep D2 as approved**; a coach or member holding the link sees who is coming without needing an account, and only delivery stays operator-only | **Open — Brian** |
