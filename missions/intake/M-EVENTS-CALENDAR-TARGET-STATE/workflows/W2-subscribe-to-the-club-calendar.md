...
- **Route/placement:** a subscribe control on the reading surfaces `W1` defines,
  and one public feed route for the open season, serving `text/calendar`.
...
| **One feed, for the open season.** When the season changes there is a new one, and a subscriber adds it                            | `locked`                                                                      | Brian, 2026-08-21: "It's one feed per season. They have to add the calendar every season." Consistent with events being owned by exactly one season                                                  | Settled                   |
