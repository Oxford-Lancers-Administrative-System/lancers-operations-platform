...
| One edit surface at `/operate/people/[personId]/edit`, sectioned as the record reads             | `locked`                    | Approved with the workflow, 2026-08-27                                                                               | Settled                     |
| A reason is required to change an existing value, and never to fill an empty one                 | `locked`                    | Approved with the workflow, 2026-08-27; Task 07 §3 requires the reason audited                                       | Settled                     |
| Contact values supersede; every other field overwrites, with the previous value in the history   | `locked`                    | Task 08 §4                                                                                                           | Settled                     |
| An email already held by another person refuses the save and offers the merge                    | `locked`                    | Approved with the workflow, 2026-08-27; Task 09 D7's rule on the correction path                                     | Settled                     |
| A concurrent edit refuses rather than wins                                                       | `locked`                    | Approved with the workflow, 2026-08-27                                                                               | Settled                     |
...
| Whether the save also sends the rejoin request, or only marks it needed                          | `delegated to Mission Lead` | **Carried, not settled.** This mission sends nothing; dispatch is Mission 4's, and marking it needed keeps that true | Carried                     |
