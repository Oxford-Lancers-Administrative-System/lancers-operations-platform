...
| List columns: name (alias-aware) · standing · what they are to the club · contactability · missing-data flag | `locked`                    | Approved with the workflow, 2026-08-27, having been judged rendered                        | Settled   |
...
| A committee-year role counts as a tie to the seasons its period overlaps                                     | `locked`                    | Approved with the workflow, 2026-08-27                                                     | Settled   |
| No season picker; the surface follows the current season as the roster does                                  | `locked`                    | Approved with the workflow, 2026-08-27; also his ruling of 2026-08-26                      | Settled   |
