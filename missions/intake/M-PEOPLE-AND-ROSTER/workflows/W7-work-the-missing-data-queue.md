...
| --------------------------------------------------------------------------------------- | --------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | -------------------------- |
| The queue names which facts are missing per row, not a count                            | `locked`                    | Approved as drawn, 2026-08-27                                                                                                | Settled                    |
...
| The queue shows an absence and never a value                                            | `locked`                    | Approved as drawn, 2026-08-27. It keeps date of birth and emergency contact off a routine screen entirely                    | Settled                    |
| Filter by which fact is missing                                                         | `locked`                    | Approved as drawn, 2026-08-27                                                                                                | Settled                    |
| The queue's entry point: a linked count, an Administration entry, or both               | `locked`                    | Settled 2026-08-27 as both routes, applied as amendment `W1-A1`                                                              | Settled                    |
...
| No `refused` or `not applicable` state; a row that cannot be satisfied persists         | `locked`                    | Approved as drawn, 2026-08-27. Task 11 §1 puts the per-fact refused state in Mission 7; inventing one here would pre-empt it | Settled, gap accepted      |
...
- Exact words: "W-7 is approved. Everything's approved."
- Date: 2026-08-27
- By: Brian Schuster
