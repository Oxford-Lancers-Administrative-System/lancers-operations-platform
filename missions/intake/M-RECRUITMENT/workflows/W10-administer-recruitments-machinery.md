...
### The QR code is not here

It was, briefly, and Brian struck it: _"the QR code doesn't go here. That doesn't
make any damn sense for the QR code to go on the messaging page. It should be on
the recruit page."_

It lives on the recruit board behind a `QR CODE` button, and on its own page at
`W1-04`. **This workflow is the cycle and nothing else.**
