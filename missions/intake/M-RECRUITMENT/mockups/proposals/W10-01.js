...
doors.append(
  ...
  doorRow("W6 · Operator add", "How we came by the number", "recruit_welcome, carrying the group link"),
);
...
cycle.append(
  step(1, "recruit_welcome", "On capture — walk-up and operator-add only", true,
       "Carries the community-group link. A QR recruit is already in the group and is skipped."),
  step(2, "recruit_details_ask", "1 day after capture", true,
       "Questionnaire A — who you are. Person facts, so they land on the person record."),
  step(3, "recruit_details_reminder", "3 days later, once only", true,
       "Never harsh: one reminder, then silence."),
  step(4, "recruit_interest_ask", "3 days after capture", true,
       "Questionnaire B — how you came to football."),
  step(5, "recruit_interest_reminder", "3 days later, once only", false,
