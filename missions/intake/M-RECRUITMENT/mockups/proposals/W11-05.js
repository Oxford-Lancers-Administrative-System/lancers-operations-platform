(async () => {
  ...
  const titleOf = (row) =>
    must(row.querySelector(".MuiTypography-body2"), "a plan row has no title");
  ...
  noteOf(recruitFollowUp).textContent =
    "Only to recruits who have not answered. Nothing follows it.";
