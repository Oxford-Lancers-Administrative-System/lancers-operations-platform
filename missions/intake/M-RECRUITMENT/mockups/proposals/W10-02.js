...
for (const control of $$(".MuiFormControl-root")) {
  if (control.querySelector(".MuiSelect-select") && /status|missing data/i.test(control.innerText)) {
    control.remove();
  }
}

const CODES = [
  { code: "qr_freshers_fair_2026", printed: "Stand banner, and 200 flyers", scans: "48", state: "Live" },
  { code: "qr_taster_2026", printed: "Pitchside board at both tasters", scans: "11", state: "Live" },
  { code: "qr_freshers_fair_2025", printed: "Last year's banner", scans: "0 this season", state: "Revoked" },
];
