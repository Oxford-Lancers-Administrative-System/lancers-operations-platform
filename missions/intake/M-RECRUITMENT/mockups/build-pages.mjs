  ...
  },
  {
    ...
    screens: [
      ...
      P(
        "W5-02",
        "Refused: no mobile",
        `Somebody who will not give a number is not captured. Your knowingly-accepted limitation, on the screen rather than in a decision log.`,
        [
          "<strong>1. Nothing is created</strong> — no person, no recruit, and no attendance row",
          "<strong>2. It says why, and what to do</strong>, rather than disabling a button and leaving the operator guessing",
