/* W4-02 — generated from the shared prelude, kit and this screen's body; see the notes inside. */
(async () => {
  /*
  ...
  /*
   * W4-02 — one social event as the Social Secretary (Manage on the Social
   * template, None on every other template). Manage shows everything in the event (audience,
   * answers, reasons, attendance) and every manage control: Edit, Cancel,
   * Delivery, Duplicate, the messaging plan, recording an answer. So the
   * page itself is unchanged; what changes is who reaches it and what the
   * shell offers them.
   *
